      ...
      <div className="flex justify-between">
        ...
        <dialog id="my_modal_1" className="modal ">
          <div className="modal-box">
            <h3 className="font-bold text-lg">⚠️ Esta acción no se puede deshacer. ¿Seguro que quieres eliminar tu historial?</h3>
            <p className="py-4">
            Si eliminas tu historial, perderás todos los animes que has guardado en tu lista. No podrás recuperar tu progreso ni los episodios que has marcado como vistos. ¡Asegúrate de estar completamente seguro antes de continuar!
            </p>
            <div className="modal-action">
              <form method="dialog">
                ...
                <button className="btn" onClick={() => {
                  localStorage.clear()
                }}>Estoy mas decidido que Goku en Namek</button>
              </form>
            </div>
          </div>
        </dialog>
